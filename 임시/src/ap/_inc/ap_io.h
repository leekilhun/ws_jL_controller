...
#define AP_IO_LOCK_END
	...
	public:
		ap_io() : m_in{}, m_out{} , m_extIn{}, m_extOut{} {
#ifdef _USE_HW_RTOS
		...
		inline void Update_io(void){
			...
			// out
			{
				...
				data[bank_3] =  (uint8_t)(m_extOut >> 8);
				data[bank_4] =  (uint8_t)(m_extOut >> 0);
			...
			// in
			{
				...
				data[bank_3] =  (uint8_t)(m_extIn >> 8);
				data[bank_4] =  (uint8_t)(m_extIn >> 0);
