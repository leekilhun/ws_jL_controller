...
#define _HW_DEF_RTOS_THREAD_PRI_FM_RECEIVE    osPriorityNormal
...
#define _HW_DEF_RTOS_THREAD_PRI_MOTOR_CMD     osPriorityNormal
#define _HW_DEF_RTOS_THREAD_PRI_PC_RECEIVE    osPriorityNormal
...
#define _HW_DEF_RTOS_THREAD_MEM_MOTOR_CMD     _HW_DEF_RTOS_MEM_SIZE( 1*1024)
#define _HW_DEF_RTOS_THREAD_MEM_FM_RECEIVE    _HW_DEF_RTOS_MEM_SIZE( 1*1024)
...
#define _HW_DEF_RTOS_THREAD_MEM_PC_RECEIVE    _HW_DEF_RTOS_MEM_SIZE( 1*1024)
#endif
